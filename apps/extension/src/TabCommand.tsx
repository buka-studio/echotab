import { Dialog, DialogContent } from "@echotab/ui/Dialog";
        ...
        <div ref={setCommandContainer} className={cn("relative flex w-full")}>
            ...
            <Dialog scrollLock={false} open={open} onOpenChange={closeDialog}>
                <DialogContent
                    ...
                    overlay={false}
                    close={false}
                    className="data-[state=closed]:slide-out-to-top-[10px] data-[state=open]:slide-in-from-top-[10px] absolute top-[-1px] max-w-4xl translate-y-0 overflow-visible p-0 data-[state=open]:border-transparent">
                    {children}
                </DialogContent>
            </Dialog>
        </div>
