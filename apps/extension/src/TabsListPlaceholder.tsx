            ...
            <div
                ...
                {Array.from({ length: count }).map((_, i) => (
                    <motion.div
                        ...
                        key={i}
                        className={cn(
                            "group/item border-border-active bg-card text-card-foreground @container dark:border-border-active/50 flex min-h-12 w-full items-center gap-5 rounded-lg border border-dashed p-2 shadow transition-colors duration-200",
                            {
