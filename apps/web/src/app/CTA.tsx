  ...
  return (
    <div className="flex flex-col items-center">
      <div className="pulse-container relative" ref={ref}>
        <div className="square absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 items-center justify-center">
          ...
          <div className="bg-background relative flex aspect-square h-[150px] items-center justify-center rounded-3xl shadow-[0_4px_4px_1px_rgba(0,0,0,.1),0_0_0_10px_hsl(var(--border))]">
