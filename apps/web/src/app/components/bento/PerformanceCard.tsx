...
import ForwardIcon from "~/../public/echotab/forward.svg";
        ...
        <BentoCard
            ...
            <div>
                ...
                <p className="text-balance text-left text-neutral-400">
                    Whether you have a few or several thousand tabs, enjoy smooth and efficient
                    usability to power up your productivity.
                </p>
            </div>
        </BentoCard>
    );
