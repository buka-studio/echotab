...
export const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 select-none",
  {
    variants: {
      variant: {
        default:
          "bg-primary/20 text-foreground shadow hover:bg-foreground/90 border border-primary/20",
        destructive:
          "bg-destructive/20 text-destructive-foreground shadow-sm hover:bg-destructive/30 border border-destructive/20",
        outline:
